...
function productFib(prod) {
  let [a, b] = [0, 1];
  // Continue as long as the product of current consecutive Fib numbers is less than prod
  while (a * b < prod) {
    // Generate the next Fibonacci number: a becomes b, b becomes a + b
    [a, b] = [b, a + b];
  }
  // Return the two numbers and whether their product exactly equals prod
  return [a, b, a * b === prod];
}
